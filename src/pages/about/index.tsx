...
const About: NextPage = () => {
  ...
  return (
    <ParallaxProvider>
      <div className="hidden h-auto w-screen flex-col gap-12 md:flex">
        <div className="flex w-auto items-end justify-between">
          <div className="flex flex-col">
            <div className="ml-10 w-[1259px]">
              <p className="font-neueRegular text-title font-medium  uppercase text-orange">
                Tout commença par une idée
              </p>
            </div>
            <div className="my-16 ml-12 w-[637px]">
              <p className="text-justify font-footer text-2xl font-normal leading-[31.2px]">
          ...
          <div className="w-auto">
            <p className="mx-10 font-neueRegular text-[100px] font-medium uppercase leading-[90px] text-redHome">
              Scroll
            </p>
          </div>
        </div>
        ...
        <div className="flex size-full flex-col bg-saumon">
          <div className="flex items-end justify-around">
            <div className="-mt-10 ml-12 h-[480px] w-[395px] rounded-[50px]">
              <Image alt="men with pride flag" src={Images.pride} />
            </div>
            <p className="z-10 -mb-40 w-[802px] text-right font-neueRegular text-[80px] leading-[72px] text-royalBlue">
          ...
          <div className="mx-20 mb-10 mt-28 flex items-center justify-around">
            <p className="w-[640px] text-justify font-footer text-[25px] font-normal leading-[32px]">
        ...
        <div className="flex size-full flex-col gap-12 bg-mainColor">
          <div className="flex items-center justify-center">
            <p className="mr-10 font-neueRegular text-[250px] uppercase text-redHome">
              Militer
            </p>
            <Image
              alt="arrow pink"
          ...
          <p className="mx-16 font-neueRegular text-[50px] italic leading-[90%]">
            Manifesto
          </p>

          <div className="mx-auto w-3/4">
            <div className="flex items-center">
              <p className="mr-14 font-footer text-[70px]">01.</p>
              <p className="font-footer text-[28px] leading-[100%]">
                L&ldquo;<span className="text-orange">inclusivité</span> et le
                respect d’autrui sont des valeurs fondamentales. Faisons de la
                diversité un engagement quotidien.
              </p>
            </div>
            <div className="flex items-center">
              <p className="mr-11 font-footer text-[70px]">02.</p>
              <p className="font-footer text-[28px] leading-[100%]">
                La <span className="text-orange">bienveillance</span> et
                l&ldquo; écoute forment la base d&ldquo;une culture
                d&ldquo;entreprise saine et productive. Le dialogue est la clé.
              </p>
            </div>
            <div className="flex items-center">
              <p className="mr-11 font-footer text-[70px]">03.</p>
              <p className="font-footer text-[28px] leading-[100%]">
                Sans <span className="text-orange">passion</span>, pas d’action.
                Croyez en votre message, je m’occupe de le partager.
              </p>
            </div>
            <div className="flex items-center">
          ...
          <div className="mx-auto mb-20 w-[200px] rounded-3xl border border-black p-[10px] hover:cursor-pointer">
            <p className="text-center text-sm font-bold uppercase leading-[17.5px] text-grayBlack">
              Services
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col md:hidden">
        <p className="font-neueRegular text-titleMobile  uppercase text-redHome hover:cursor-pointer">
          Partage
        </p>
        <p className="font-neueRegular text-titleMobile  uppercase text-redHome hover:cursor-pointer">
          Création
